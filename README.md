# 100_days_of_python_bootcamp_projects
**Showcase of my python learning journey**

The purpose of this repository is to track my progress in Python. Coming form a non CS engineering background, I am building my skills to transition into a developer role focused on Fintech and business applications.

The table below tracks my daily projects throughout the bootcamp.

## 📅 The 100-Day journey and roadmap

| Day | Project / Script | Key Concepts | Link |
| :---: | :--- | :--- | :---: |
| 01 | **Band Name Generator** (`Proj1_Day1.py`) | Input, Variables, String Concatenation | [View](./Day1/) |
